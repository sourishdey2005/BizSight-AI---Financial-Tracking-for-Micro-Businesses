      ...
      <nav className="fixed top-0 w-full bg-white/80 backdrop-blur-xl z-50 border-b border-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8 text-sm font-bold text-slate-500">
            ...
            <a href={STREAMLIT_URL} className="hover:text-blue-600 transition">Live Demo</a>
          </div>

          <div className="flex items-center gap-4">
            <a href={STREAMLIT_URL} className="text-sm font-bold text-slate-700 hover:text-blue-600 transition px-4">Login</a>
            <a href={STREAMLIT_URL} className="bg-slate-900 text-white px-6 py-3 rounded-full text-sm font-bold hover:bg-blue-600 transition shadow-lg shadow-slate-200">
              Get Started
            </a>
          </div>
        </div>
      ...
      <main>
        ...
        <section className="pt-40 pb-20 px-4">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-slate-500 max-w-2xl mx-auto mb-12 font-medium leading-relaxed animate-reveal delay-200">
              BizSight AI is the open-source financial operating system for Indian micro-businesses. Track every Paisa, predict every sale, and grow with confidence.
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-reveal delay-300">
              <a href={STREAMLIT_URL} className="w-full sm:w-auto bg-blue-600 text-white px-10 py-5 rounded-2xl font-bold text-lg hover:bg-blue-700 shadow-2xl shadow-blue-200 transition flex items-center justify-center gap-2">
                Start Free Trial <ArrowRight className="w-5 h-5" />
              </a>
              <a href={STREAMLIT_URL} className="w-full sm:w-auto bg-white text-slate-900 border-2 border-slate-100 px-10 py-5 rounded-2xl font-bold text-lg hover:bg-slate-50 transition">
                View Dashboard
              </a>
            </div>
        ...
        <section id="features" className="py-24 bg-slate-50">
          <div className="max-w-7xl mx-auto px-4">
             <div className="text-center mb-20">
                <h2 className="text-4xl font-black text-slate-900 mb-4 tracking-tight">Built for Kirana stores & SMEs.</h2>
             ...
             <div className="grid md:grid-cols-2 gap-16 items-center mb-32">
                <div className="order-2 md:order-1">
                   ...
                   <p className="text-slate-600 text-lg leading-relaxed mb-6 font-medium">
                      Our proprietary AI analyzes your historical sales patterns to predict demand spikes before they happen. Never lose a sale due to lack of stock or missed Diwali opportunities.
                   </p>
                   <ul className="space-y-3">
                      ...
                      <li className="flex items-center gap-2 text-slate-700 font-bold text-sm"><Check className="text-blue-600 w-5 h-5" /> Festival Pattern Recognition</li>
             ...
             <div className="grid md:grid-cols-2 gap-16 items-center">
                <div className="bg-white p-4 rounded-[2.5rem] shadow-2xl border border-slate-100">
                   <img src="https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?auto=format&fit=crop&q=80&w=1000" alt="Inventory Management" className="rounded-[2rem] w-full" />
                </div>
                <div>
                   ...
                   <p className="text-slate-600 text-lg leading-relaxed mb-6 font-medium">
                      Automatically link your COGS to every sale. BizSight calculates your net profit in real-time, subtracting supplier costs, GST, and shipping automatically.
                   </p>
        ...
        <section className="py-24 bg-slate-900 text-white">
           <div className="max-w-7xl mx-auto px-4 grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
              <div>
                 <p className="text-5xl font-black mb-2">₹10Cr+</p>
                 <p className="text-slate-400 font-bold text-sm uppercase tracking-widest">Revenue Tracked</p>
              </div>
              <div>
                 <p className="text-5xl font-black mb-2">2500+</p>
                 <p className="text-slate-400 font-bold text-sm uppercase tracking-widest">Indian Sellers</p>
              </div>
              <div>
              ...
              <div>
                 ...
                 <p className="text-slate-400 font-bold text-sm uppercase tracking-widest">Expert Support</p>
              </div>
           </div>
        </section>
        ...
        <section className="py-24 bg-slate-50 overflow-hidden">
           <div className="max-w-7xl mx-auto px-4">
              ...
              <div className="grid md:grid-cols-3 gap-8">
                 <TestimonialCard 
                    quote="Before BizSight, I was using three different registers. Now I have everything in one dashboard. The AI forecast helped me prepare for the Diwali rush!"
                    author="Anita Sharma"
                    role="Anita's Boutique, Delhi"
                 />
                 <TestimonialCard 
                    quote="As an online seller on Amazon, tracking unit costs across multiple suppliers was a nightmare. BizSight's automated COGS is a lifesaver for my margins."
                    author="Amit Verma"
                    role="Verma Electronics, Bangalore"
                 />
                 <TestimonialCard 
                    quote="The clean UI makes it easy for my staff to log sales without any training. Highly recommended for any small business owner in India."
                    author="Suresh Iyer"
                    role="Iyer's Corner Cafe, Mumbai"
                 />
              </div>
           </div>
        </section>
        ...
        <section className="py-24 bg-blue-600 relative overflow-hidden">
           ...
           <div className="max-w-5xl mx-auto px-4 text-center relative z-10">
              ...
              <p className="text-xl text-blue-100 mb-10 max-w-2xl mx-auto font-medium">
                 Join thousands of Indian businesses already tracking their growth with BizSight AI. Start your journey today.
              </p>
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                 <a href={STREAMLIT_URL} className="bg-white text-blue-600 px-10 py-5 rounded-2xl font-black text-xl hover:bg-blue-50 transition shadow-2xl">
                    Create Account Now
                 </a>
            ...
            <div className="grid md:grid-cols-4 gap-12 mb-16">
               ...
               <div>
                  ...
                  <ul className="space-y-4 text-slate-500 font-bold text-sm">
                     ...
                     <li><a href={STREAMLIT_URL} className="hover:text-blue-600 transition">Live Demo</a></li>
                  </ul>
               </div>
